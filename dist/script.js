...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.handleChange = function (selectType) {
      var active = _this.state.activeItem;
      active++;

      // return things back to the beginning for continuity's sake
      if (_this.state.activeItem === _this.state.data.length) {
        _this.setState({
          activeItem: 1
        });
        active = 1;
      ...
      var answered = _this.state.answeredItem;
      answered++;

      // return things back to the beginning for continuity's sake
      if (_this.state.answeredItem === _this.state.data.length) {
        _this.setState({
          answeredItem: 1
        });
        answered = 1;
      ...
      var matched = false;
      if (_this.state.data[active - 1].likesYou && selectType !== 'pass') {
        matched = _this.state.data[active - 1].likesYou;
      }
      ...
      if (!matched) {
        ...
        _this.setState({
          matched: matched,
          matchedUser: _this.state.data[_this.state.answeredItem],
          selectType: type
        });
      }
    };

    _this.continuePlaying = function () {
      _this.setState({
        activeItem: _this.state.activeItem + 1,
        answeredItem: _this.state.answeredItem + 1,
        matched: false
      });
    };
  ...
  _createClass(App, [{
    ...
    value: function fetchData() {
      ...
      var url = 'https://my-json-server.typicode.com/airtame/kittens/kittens';
    ...
    value: function render() {
      return _react2.default.createElement(
        'section',
        null,
        _react2.default.createElement(_Match2.default, { data: this.state, continuePlaying: this.continuePlaying }),
        _react2.default.createElement(_Header2.default, null),
        _react2.default.createElement(_Card2.default, { data: this.state }),
        _react2.default.createElement(_Buttons2.default, { handleChange: this.handleChange })
      );
    }
  }]);
...
var _UserInfo = __webpack_require__(27);
...
function Card(props) {
  var cards = props.data.data.map(function (kitten) {
    var stateClass = props.data.activeItem === kitten.id ? 'active card' : 'inactive card';
    var decisionClass = '';
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_UserInfo2.default, { user: kitten })
    );
  });
...
var KittenInfo = function (_React$Component) {
  _inherits(KittenInfo, _React$Component);

  function KittenInfo(props) {
    _classCallCheck(this, KittenInfo);

    var _this = _possibleConstructorReturn(this, (KittenInfo.__proto__ || Object.getPrototypeOf(KittenInfo)).call(this, props));
  ...
  _createClass(KittenInfo, [{
    key: 'render',
    value: function render() {
      var usersInterests = void 0;
      var displayText = 'more';

      if (this.state.shown) {
        usersInterests = _react2.default.createElement(
          'div',
          { className: 'kitten-info__interests' },
          _react2.default.createElement(
            'p',
            { className: 'kitten-info__interests-title' },
            'Interests'
          ),
          _react2.default.createElement(
            'ul',
            { className: 'kitten-info__interests-list' },
            this.props.user.interests.map(function (interest, index) {
              return _react2.default.createElement(
                'li',
                { key: index },
                interest
      ...
      return _react2.default.createElement(
        'div',
        { className: 'kitten-info' },
        _react2.default.createElement(
          'p',
          { className: 'kitten-info__name' },
          this.props.user.name,
          _react2.default.createElement(
            'span',
            { className: 'kitten-info__more', onClick: this.handleClick },
            'Show ',
            displayText,
            ' ',
            _react2.default.createElement('i', { className: 'icon-info-circled' })
          )
        ),
        _react2.default.createElement(
          'p',
          { className: 'kitten-info__bio' },
          this.props.user.bio
        ),
        usersInterests
      );
...
function Match(props) {
  ...
  if (props.data.matched) {
    match = _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: 'match-overlay__message' },
        'It\'s a match!'
      ),
      _react2.default.createElement(
        'div',
        { className: 'match-overlay__users' },
        _react2.default.createElement(
          'div',
          { className: 'match-overlay__user-info' },
          _react2.default.createElement('div', { className: 'profile-photo profile-photo--user' }),
          _react2.default.createElement(
            'small',
            null,
            'You'
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'small',
            null,
            props.data.matchedUser.name
          )
        )
      ),
      _react2.default.createElement(
        'button',
        { className: 'match-overlay__continue', onClick: props.continuePlaying },
        'Continue playing'
      )
    );
  }
...
function Header() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "h1",
      { className: "product-header__name" },
      _react2.default.createElement("i", { className: "icon-fire", style: { marginRight: .2 + 'em' } }),
      "Kittens"
    ),
    _react2.default.createElement("div", { className: "profile-photo profile-photo--user" })
  );
...
function Buttons(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'button',
      { id: 'pass', onClick: function onClick() {
          return props.handleChange('pass');
        } },
      _react2.default.createElement('i', { className: 'icon-cancel' })
    ),
    _react2.default.createElement(
      'button',
      { id: 'super-like', onClick: function onClick() {
          return props.handleChange('super');
        } },
      _react2.default.createElement('i', { className: 'icon-star' })
    ),
    _react2.default.createElement(
      'button',
      { id: 'like', onClick: function onClick() {
          return props.handleChange('like');
        } },
